...
export function transaction_toCompactBytesHex(a: number, b: number): void;
...
export function signature_toDER(a: number, b: number): void;
export function signature_toCompactBytes(a: number, b: number): void;
export function signature_verifyMessage(a: number, b: number, c: number, d: number): number;
export function signature_fromDER(a: number, b: number, c: number): number;
export function signature_fromHexDER(a: number, b: number, c: number): number;
