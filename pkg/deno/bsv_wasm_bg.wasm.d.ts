...
export function eciesciphertext_extractPublicKey(a: number, b: number): void;
export function eciesciphertext_fromBytes(a: number, b: number, c: number, d: number): void;
...
export function transaction_signWithK(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): void;
...
export function sighashsignature_fromBytes(a: number, b: number, c: number, d: number, e: number): void;
...
export function ecies_encryptWithEphemeralKey(a: number, b: number, c: number, d: number): void;
export function ecies_decrypt(a: number, b: number, c: number, d: number): void;
export function ecies_deriveCipherKeys(a: number, b: number, c: number): void;
...
export function publickey_verifyMessage(a: number, b: number, c: number, d: number, e: number): void;
export function publickey_toAddress(a: number, b: number): void;
export function publickey_toCompressed(a: number, b: number): void;
export function publickey_toDecompressed(a: number, b: number): void;
export function publickey_encryptMessage(a: number, b: number, c: number, d: number, e: number): void;
...
export function ecdsa_verify(a: number, b: number, c: number, d: number, e: number, f: number): void;
...
export function extendedprivatekey_deriveChild(a: number, b: number, c: number): void;
export function extendedprivatekey_derive(a: number, b: number, c: number, d: number): void;
export function extendedprivatekey_fromSeed(a: number, b: number, c: number): void;
export function extendedprivatekey_fromRandom(a: number): void;
export function extendedprivatekey_fromString(a: number, b: number, c: number): void;
export function extendedprivatekey_toString(a: number, b: number): void;
export function extendedprivatekey_fromMnemonic(a: number, b: number, c: number, d: number, e: number): void;
...
export function extendedpublickey_deriveChild(a: number, b: number, c: number): void;
export function extendedpublickey_derive(a: number, b: number, c: number, d: number): void;
export function extendedpublickey_fromSeed(a: number, b: number, c: number): void;
export function extendedpublickey_fromRandom(a: number): void;
export function extendedpublickey_fromString(a: number, b: number, c: number): void;
...
export function txin_getUnlockingScriptSize(a: number, b: number): void;
export function txin_getUnlockingScript(a: number): number;
export function txin_getUnlockingScriptHex(a: number, b: number): void;
...
export function txin_setLockingScript(a: number, b: number): void;
export function txin_getLockingScript(a: number): number;
export function txin_getLockingScriptBytes(a: number, b: number): void;
export function txin_fromHex(a: number, b: number, c: number): void;
export function txin_toJSON(a: number, b: number): void;
...
export function txin_fromOutpointBytes(a: number, b: number, c: number): void;
export function txin_toCompactBytes(a: number, b: number): void;
export function txin_toCompactHex(a: number, b: number): void;
export function txin_fromCompactBytes(a: number, b: number, c: number): void;
export function txin_fromCompactHex(a: number, b: number, c: number): void;
export function txin_getFinalisedScript(a: number, b: number): void;
...
export function signature_rHex(a: number, b: number): void;
export function signature_s(a: number, b: number): void;
export function signature_sHex(a: number, b: number): void;
...
export function signature_fromDER(a: number, b: number, c: number): void;
export function signature_fromHexDER(a: number, b: number, c: number): void;
export function signature_fromCompactBytes(a: number, b: number, c: number): void;
export function signature_recoverPublicKey(a: number, b: number, c: number, d: number, e: number): void;
export function kdf_pbkdf2(a: number, b: number, c: number, d: number, e: number, f: number, g: number): number;
export function ecdsa_signWithRandomK(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function ecdsa_sign(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function ecdsa_signWithK(a: number, b: number, c: number, d: number, e: number, f: number): void;
...
export function p2pkhaddress_fromPubKeyHash(a: number, b: number, c: number): void;
export function p2pkhaddress_fromPubKey(a: number, b: number): void;
export function p2pkhaddress_setChainParams(a: number, b: number, c: number): void;
export function p2pkhaddress_toString(a: number, b: number): void;
export function p2pkhaddress_fromString(a: number, b: number, c: number): void;
export function p2pkhaddress_toLockingScript(a: number, b: number): void;
export function p2pkhaddress_toUnlockingScript(a: number, b: number, c: number, d: number): void;
export function p2pkhaddress_verifyBitcoinMessage(a: number, b: number, c: number, d: number, e: number): void;
export function __wbg_scripttemplate_free(a: number): void;
export function scripttemplate_from_script(a: number, b: number): void;
export function scripttemplate_from_asm_string(a: number, b: number, c: number): void;
export function script_matches(a: number, b: number, c: number): void;
...
export function privatekey_fromWIF(a: number, b: number, c: number): void;
export function privatekey_fromHex(a: number, b: number, c: number): void;
export function privatekey_signMessage(a: number, b: number, c: number, d: number): void;
...
export function privatekey_encryptMessage(a: number, b: number, c: number, d: number): void;
...
export function bytes_fromHex(a: number, b: number, c: number): void;
export function ecdsa_privateKeyFromSignatureK(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
export function bsm_isValidMessage(a: number, b: number, c: number, d: number): number;
export function bsm_verifyMessage(a: number, b: number, c: number, d: number, e: number): void;
export function bsm_signMessage(a: number, b: number, c: number, d: number): void;
export function bsm_signMessageWithK(a: number, b: number, c: number, d: number, e: number): void;
...
export function txout_fromHex(a: number, b: number, c: number): void;
export function txout_toBytes(a: number, b: number): void;
export function txout_toHex(a: number, b: number): void;
export function txout_toJSON(a: number, b: number): void;
...
export function transaction_fromHex(a: number, b: number, c: number): void;
...
export function transaction_fromJsonString(a: number, b: number, c: number): void;
export function transaction_toJSON(a: number, b: number): void;
export function transaction_toBytes(a: number, b: number): void;
export function transaction_toHex(a: number, b: number): void;
export function transaction_getSize(a: number, b: number): void;
export function transaction_addInputs(a: number, b: number, c: number): void;
export function transaction_getOutpoints(a: number, b: number): void;
...
export function transaction_fromCompactBytes(a: number, b: number, c: number): void;
export function transaction_fromCompactHex(a: number, b: number, c: number): void;
...
export function script_fromHex(a: number, b: number, c: number): void;
export function script_fromBytes(a: number, b: number, c: number): void;
export function script_fromASMString(a: number, b: number, c: number): void;
...
export function script_toScriptBits(a: number, b: number): void;
