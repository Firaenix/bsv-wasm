...
#[cfg_attr(target_arch = "wasm32", wasm_bindgen)]
impl Hash {
    #[cfg_attr(target_arch = "wasm32", wasm_bindgen(js_name = sha256d))]
    pub fn sha_256d(input: &[u8]) -> Self {
        Hash((&*Sha256d::digest(input)).to_vec())
    }

    #[cfg_attr(target_arch = "wasm32", wasm_bindgen(js_name = sha256))]
    pub fn sha_256(input: &[u8]) -> Self {
        Hash((&*Sha256::digest(input)).to_vec())
    }

    #[cfg_attr(target_arch = "wasm32", wasm_bindgen(js_name = sha1))]
    pub fn sha_1(input: &[u8]) -> Self {
        Hash((&*Sha1::digest(input)).to_vec())
    }

    #[cfg_attr(target_arch = "wasm32", wasm_bindgen(js_name = ripemd160))]
    pub fn ripemd_160(input: &[u8]) -> Self {
        Hash((&*Ripemd160::digest(input)).to_vec())
    }

    #[cfg_attr(target_arch = "wasm32", wasm_bindgen(js_name = hash160))]
    pub fn hash_160(input: &[u8]) -> Self {
        Hash((&*Hash160::digest(input)).to_vec())
    }

    #[cfg_attr(target_arch = "wasm32", wasm_bindgen(js_name = sha512))]
...
impl Hash {
    ...
    #[cfg_attr(target_arch = "wasm32", wasm_bindgen(js_name = sha512Hmac))]
    ...
    #[cfg_attr(target_arch = "wasm32", wasm_bindgen(js_name = sha256Hmac))]
    ...
    #[cfg_attr(target_arch = "wasm32", wasm_bindgen(js_name = sha256dHmac))]
    ...
    #[cfg_attr(target_arch = "wasm32", wasm_bindgen(js_name = sha1Hmac))]
    ...
    #[cfg_attr(target_arch = "wasm32", wasm_bindgen(js_name = ripemd160Hmac))]
    ...
    #[cfg_attr(target_arch = "wasm32", wasm_bindgen(js_name = hash160Hmac))]
