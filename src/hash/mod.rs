...
#[cfg_attr(all(feature = "wasm-bindgen-hash"), wasm_bindgen)]
...
#[cfg_attr(all(feature = "wasm-bindgen-hash"), wasm_bindgen)]
impl Hash {
    #[cfg_attr(all(feature = "wasm-bindgen-hash"), wasm_bindgen(js_name = toBytes))]
    pub fn to_bytes(&self) -> Vec<u8> {
        self.0.clone()
    }

    #[cfg_attr(all(feature = "wasm-bindgen-hash"), wasm_bindgen(js_name = toHex))]
...
impl Hash {
    ...
    #[cfg_attr(all(feature = "wasm-bindgen-hash"), wasm_bindgen(js_name = sha512Hmac))]
    ...
    #[cfg_attr(all(feature = "wasm-bindgen-hash"), wasm_bindgen(js_name = sha256Hmac))]
    ...
    #[cfg_attr(all(feature = "wasm-bindgen-hash"), wasm_bindgen(js_name = sha256dHmac))]
    ...
    #[cfg_attr(all(feature = "wasm-bindgen-hash"), wasm_bindgen(js_name = sha1Hmac))]
    ...
    #[cfg_attr(all(feature = "wasm-bindgen-hash"), wasm_bindgen(js_name = ripemd160Hmac))]
    ...
    #[cfg_attr(all(feature = "wasm-bindgen-hash"), wasm_bindgen(js_name = hash160Hmac))]
