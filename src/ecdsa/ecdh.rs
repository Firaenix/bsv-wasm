...
impl ECDH {
   ...
   */
  pub(crate) fn derive_shared_key_impl(priv_key: Option<PrivateKey>, pub_key: &PublicKey) -> Result<Vec<u8>, BSVErrors> {
...
impl ECDH {
  ...
  pub fn derive_shared_key(priv_key: Option<PrivateKey>, pub_key: &PublicKey) -> Result<Vec<u8>, JsValue> {
