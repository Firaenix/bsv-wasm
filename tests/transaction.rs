...
mod tests {
  ...
  #[test]
  #[wasm_bindgen_test]
  fn txout_from_hex_fail() {
    let txout_hex = "";
    let txout = TxOut::from_hex(txout_hex.to_string());

    assert_eq!(txout.is_err(), true);
  }
}