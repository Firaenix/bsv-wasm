...
mod transaction_tests {
    ...
    fn deserialise_transaction_hex() {
        ...
        assert_eq!(
            ...
            hex::decode("3f36d1e82cd2f327970c84cbf0d4e4d116f9a15dd02259329ac40d7b6a018d9e")
                .unwrap()
        );
        ...
        assert_eq!(
            tx_out_0.get_script_pub_key(),
            hex::decode("76a91420bb5c3bfaef0231dc05190e7f1c8e22e098991e88ac").unwrap()
        );
        ...
        assert_eq!(
            tx_out_1.get_script_pub_key(),
            hex::decode("76a9149e3e2d23973a04ec1b02be97c30ab9f2f27c3b2c88ac").unwrap()
        );
    ...
    fn add_txins_to_transaction_wasm() {
        ...
        let boxed_vals = Box::from(vec![
            JsValue::from(txin1.clone()),
            JsValue::from(txin2.clone()),
            JsValue::from(txin3.clone()),
        ]);
        ...
        assert_eq!(
            tx.get_input(4).unwrap().get_outpoint_hex(None),
            txin3.get_outpoint_hex(None)
        );
    }
    ...
    fn add_txouts_to_transaction() {
        ...
        let boxed_vals = Box::from(vec![
            JsValue::from(txout1.clone()),
            JsValue::from(txout2.clone()),
            JsValue::from(txout3.clone()),
        ]);
