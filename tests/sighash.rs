...
use bsv_wasm::*;
  ...
  fn sighash_single_bug() {
    ...
    let sighash_buf = tx.sighash(1, sighash, &signing_script, 0).unwrap();
  ...
  fn sighash_inputs_output_SINGLE() {
    ...
    let sighash_buf = tx.sighash(0, sighash, &signing_script, 0).unwrap();

    assert_eq!(sighash_buf.to_hex(), "5e427823c01816b866af89e3bd679154f54d0e91a7e63bc91e420a6a57992a86")
  }
}