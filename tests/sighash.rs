...
use bsv_wasm::*;
  ...
  fn SIGHASH_NONE_ANYONECANPAY_NO_FORK_ID() { 
    ...
    let sighash_buffer = tx.sighash_preimage(SigHash::try_from(sighash).unwrap() , 0, &signing_script, 0).unwrap();
    ...
    assert_eq!(tx.sign(&priv_key, SigHash::try_from(sighash).unwrap(), 0, &signing_script, 0).unwrap().to_hex().unwrap(), "30440220798bd19a0bb1fd5e1b3832e46ae69af687d87cbd179a81e60af719382860aee502206d849665f4010a54f40d9ac463629cbd758042745cebf7122818d9bfea2bce7043")
  }
}