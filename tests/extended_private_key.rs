...
mod xpriv_tests {
    ...
    fn from_xprv_string() {
        ...
        assert_eq!(
            key.to_string().unwrap(),
            "xprv9s21ZrQH143K2rdSf96bvxvYtHYjf2899A7M7S3Ka2jASLK6P3hs7Bg9snGVsArqAA2awhc26e5kqKDquKSkpZ6hXymjpCcUj1tRi17L4Bg"
        )
    }
    ...
    fn seed_to_xprv() {
        ...
        assert_eq!(
            key.to_string().unwrap(),
            "xprv9s21ZrQH143K3UHKxrxdUicfntW2v9RRm2YGc1Fvs44cNMLfrXERKaSzziw6qVMcN6EFiT2uEYDNgSxopNFEGBjBZkHXRWQkTe8ePpAviwT"
        );
    }
    ...
    fn non_standard__long_seed_to_xprv() {
        ...
        assert_eq!(
            key.to_string().unwrap(),
            "xprv9s21ZrQH143K2iZ72grdBYHPdmnrwYwmUHQkSpW6hnVCcYKVMr2V5A7AYDerUumeMVaZ98FAY5viaMkJ6a1bU3s5aHYbyErWotxAPBMQx4m"
        );
    }
    ...
    fn non_standard__short_seed_to_xprv() {
        ...
        assert_eq!(
            key.to_string().unwrap(),
            "xprv9s21ZrQH143K3W67FQwsDcvjkiQ6NJaKxBL4bSpATvZ1DtNrJQAfJYZX3Dscv5GFu6oaWTsn5DDD335wopZqLs1QYCGMLyF4c8xcc12URrY"
        );
    }
